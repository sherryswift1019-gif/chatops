...
await pool.end()
console.log('✅ Database schema applied (v1 ~ v26 + v28 + v29 + v30, 含 PRD V2 metrics v23 + Arch Agent v24 + pam bootstrap v25 + capability prompts v26 + PRD active submit MR v28 + product_lines FK cascade v29 + PRD MR identity switch userId v30)')
